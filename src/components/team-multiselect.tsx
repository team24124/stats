...
export interface Option {
  ...
  [key: string]: string | boolean | undefined | Team;
}
...
const TeamMultiselector = React.forwardRef<MultipleSelectorRef, MultipleSelectorProps>(
  (
    {
      value,
      onChange,
    ...
    const handleUnselect = React.useCallback(
      (option: Option) => {
        const newOptions = selected.filter((s) => s.team.team_number !== option.team.team_number);
        ...
        >
          <div className="relative flex flex-wrap gap-1">
            ...
            <button
              ...
              className={cn(
                'relative ltr:right-0 rtl:left-0 h-6 w-6 p-0',
                (hideClearAllButton ||
                  disabled ||
                  selected.length < 1 ||
                        ...
                        {dropdowns
                          ...
                          .map((option) => {
                            return (
                              <CommandItem
                                key={option.team.team_number}
                                value={option.team.team_number.toString()}
                              ...
                              >
                                <div className="font-bold text-base">{option.team.team_number}</div> {option.team.team_name}
                              </CommandItem>
                            );
                          })}
                      </>
...
TeamMultiselector.displayName = 'TeamMultiselector';
