...
function Index() {
  ...
  return (
    <main>
      ...
      <p>Welcome to the Nighthawks Robotics Statistics dashboard. Providing up-to-date OPR and EPA statistics calculations and visualization for FIRST Tech Challenge teams. Data is updated hourly from Friday to Sunday, and daily at 00:00 UTC on other days.</p>
