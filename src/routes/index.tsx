...
function Index() {
  ...
  return (
    <main>
      ...
      <a href='https://frc-events.firstinspires.org/services/API'><i><p className='text-muted-foreground'>Event Data provided by FIRST is updated daily at 00:00 UTC.</p></i></a>
    </main>
  )
}